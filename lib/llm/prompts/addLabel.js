...
module.exports = function getLabelPrompt(label, question) {
  return `
# Role: 标签匹配专家
...
## OutputFormat:
1. 输出结果必须是一个数组，每个元素包含 question、file 和 label 字段。
...
7. 输出结果必须是一个数组，每个元素包含 question、file 和 label 字段（只输出这个，不要输出任何其他无关内容）
